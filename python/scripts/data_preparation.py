...
def validateDataFile(filename):
    ...
    if has_nan_values: raise Exception(f'CSV file {filename}.csv contains NaN values!')
    if has_zero_values: raise Exception(f'CSV file {filename}.csv contains Zero values!')
